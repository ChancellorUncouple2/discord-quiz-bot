...
> Discord quiz and trivia bot, leaderboards categories 2026 — free, open-source, easy to set up.

<br>

## ✨ Features

❓ &nbsp;**Custom quizzes** — create quizzes on any topic

🏆 &nbsp;**Leaderboard** — real-time rankings

⏱️ &nbsp;**Timed questions** — add time pressure

🎯 &nbsp;**Categories** — trivia for any subject

📊 &nbsp;**Results** — detailed breakdown after quiz

🔄 &nbsp;**Scheduled** — recurring weekly trivia
